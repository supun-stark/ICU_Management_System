...
<body id="page-top">
    ...
    <img src="assets/img/dogs/ticknew.png" alt="Avatar" style="width:160px;height:160px; class="avatar"><br><br>
  </div>
            <div class="container-fluid">
               
                 <h2 style = "color:#0000CD">Successfully Inserted</h2> 
           
			<a href="Viewnew.jsp">
					<button class="btn btn-primary" style="margin:5px;">View Table</button>
				</a>
            </div>
