...
<body id="page-top">
    ...
    <sql:query var="listUsers"   dataSource="${myDS}">
        SELECT * FROM patients ;
     			  ...
     			  <center>
				 <h2 style = "color:#0000CD">Patient Details Table</h2>
				<br><br></center>
            ...
            <c:forEach var="user" items="${listUsers.rows}">
                <tr>
                    ...
                    <td style="color:#0000CD"><c:out value="${user.LastName}" /></td>
                     ...
                     <td><a href="updatedata.jsp"><input type="button" name="Edit" value="Update" style="background-color:#4CAF50" ></a><br>
                      <a href="deletedata.jsp"><input type="button" name="delete" value="Delete" style="background-color:Red"></a></td>
		...
		<a href="PatientHome.jsp">
				...
				<a href="PatientHome.jsp">
					<button class="btn btn-primary" style="margin:5px;">Generate reports</button>
				</a> 
				</center>
