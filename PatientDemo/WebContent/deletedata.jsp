...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <script >
    function validateForm(){
    	...
    	var deleteid = document.forms["DeleteDataForm"]["id"].value;
...
<body id="page-top">
    ...
    <div align="center">
		...
		<br><br>
		 <h2 style = "color:#0000CD">Delete Patient Details</h2> 
		 <style>
			h2 {text-align: center;}
			</style>	             
    <form name ="DeleteDataForm"form action ="del" style = "display: inline-block; margin-top: 40px" method="post" onsubmit="return validateForm()">
	
		<div class = "left" style = "float: left; width: 500px; overflow: hidden; margin-left: 50px">
            
            Enter Patient ID<br><input type="text" style = "border: 1px solid #0066ff;  border-radius: 7px; width: 300px;height: 25px"  name="id"><br><br>
