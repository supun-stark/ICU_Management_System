...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>ICU<br></span></div>
                </a>
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="profile.html"><i class="fas fa-user"></i><span>Patients</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <h1 style = "color:#0000CD">Patient Home</h1><br><br> 
            <style>
  ...
  <div class="imgcontainer">
    <img src="assets/img/avatars/patientvector.jpg" alt="Avatar" style="width:230px; height:210px; class="avatar"><br><br>
  </div>
	</center>	
 	<div id="log" align="center" >
	<a href="insertdata.jsp"><input type="button" name="Add" value="Add Patients" style = "border: 2px solid #0066ff;  font-size: 20px; color: #008CBA;  border-radius: 10px; width: 500px; height: 50px"></a><br>
	<a href="updatedata.jsp"><input type="button" name="Edit" value="Edit Patients" style = "border: 2px solid #0066ff; font-size: 20px; color: #008CBA;  border-radius: 10px; width: 500px; height: 50px"></a><br>
	<a href="deletedata.jsp"><input type="button" name="Delete" value="Delete Patients" style = "border: 2px solid #0066ff; font-size: 20px; color: #008CBA;  border-radius: 10px; width: 500px; height: 50px"></a><br>
	<a href="searchdata.jsp"><input type="button" name="Home" value="Search Patients" style = "border: 2px solid #0066ff; font-size: 20px; color: #008CBA;  border-radius: 10px; width: 500px; height: 50px"></a><br>
	<a href="Viewnew.jsp"><input type="button" name="Reports" value="Print Patients" style = "border: 2px solid #0066ff; font-size: 20px; color: #008CBA;  border-radius: 10px; width: 500px; height: 50px"></a><br>
	</div>
